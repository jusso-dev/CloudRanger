...
describe("fixtures capture", () => {
  it("captures, sanitises, validates the verdict, and appends cases", async () => {
  ...
  it("refuses to write when the engine disagrees with the declared verdict", async () => {
  ...
  it("rejects unknown controls and bad expected values", async () => {
